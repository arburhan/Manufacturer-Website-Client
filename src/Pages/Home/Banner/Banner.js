        ...
        >
            <div className='flex items-center justify-center h-full px-3' >
                <div className='banner-text text-center'>
                    ...
                    <p className='py-4' >Distributing high end tools to help create your ideal vision for a project, home, or application. We are your partners, confidants and most importantly your guidance to help you complete projects that matter.</p>
