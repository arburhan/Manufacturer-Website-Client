            ...
            <div className='flex flex-col md:flex-row justify-center gap-8 lg:gap-28' >
                <div className='card w-96 p-4  hover:bg-base-300'>
                    ...
                    <div className='my-5'>
                        ...
                        <figure style={{ justifyContent: 'flex-start' }} className='flex items-center' >
                            <svg xmlns="http://www.w3.org/2000/svg" class="h-18 w-12" viewBox="0 0 20 20" fill="currentColor">
                ...
                <div className=' card w-96 p-4 hover:bg-base-300'>
                    ...
                    <div className="form-control">
                        ...
                        <textarea class="textarea textarea-bordered h-24" placeholder="Your message is here"></textarea>
                    </div>
